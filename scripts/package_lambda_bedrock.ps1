[CmdletBinding()]
param(
    [string]$OutputPath = "build/checkmate-ai-grading-bedrock.zip",
    [string]$RequirementsPath = "requirements-lambda-bedrock.txt",
...
$BuildRoot = [System.IO.Path]::GetFullPath((Join-Path $RepoRoot "build\lambda-bedrock"))
